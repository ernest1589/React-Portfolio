...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full h-screen bg-[#618B4A] flex justify-center items-center p-4"
    >
      <form
        method="POST"
      ...
      >
        <div className="pb-8">
          <p className="text-4xl font-bold inline border-b-4 border-[#54c5e5] text-[#D7F9F1]">
            Contact
          </p>
          <p className="text-[#D7F9F1] py-4">
